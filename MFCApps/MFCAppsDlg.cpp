...
// MFCAppsDlg.cpp : implementation file
//

#include "pch.h"
#include "framework.h"
#include "MFCApps.h"
#include "MFCAppsDlg.h"
...
// CMFCAppsDlg message handlers

BOOL CMFCAppsDlg::OnInitDialog()
{
	...
	if (pSysMenu != nullptr)
	{
		...
		ASSERT(bNameValid);
		TRACE(strAboutMenu);
		auto* p = new CString(strAboutMenu);
		std::wcerr << strAboutMenu;
...
void CMFCAppsDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CMFCAppsDlg::OnQueryDragIcon()
{
