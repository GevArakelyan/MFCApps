...
protected: // create from serialization only
	CFirstMDIView() noexcept;
	DECLARE_DYNCREATE(CFirstMDIView)

// Attributes
public:
	CFirstMDIDoc* GetDocument() const;
...
inline CFirstMDIDoc* CFirstMDIView::GetDocument() const
   { return reinterpret_cast<CFirstMDIDoc*>(m_pDocument); }
#endif
